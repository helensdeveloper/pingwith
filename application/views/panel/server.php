...
<body class="hold-transition sidebar-mini layout-fixed">
										...
										<tbody>
											<tr>
												...
												<td>
													...
													<?php }elseif ($status == 0) { ?>
														<small class="badge badge-danger">Deactive</small>
													<?php } ?>
												</td>
												<td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-edit">
		...
		<div class="modal fade" id="modal-edit">
			<div class="modal-dialog modal-sm">
				<div class="modal-content">
					...
					<form autocomplete="off" action="<?=base_url().'server/setserver'?>" method="POST">
						<div class="modal-body">
							<div class="form-group">
								<span>Server Name</span>
								<input type="text" class="form-control" value="<?=$servername?>" name="name">
							</div>
							<div class="form-group">
	...
	<script src="<?=base_url().'template/custom/server.js'?>"></script>
